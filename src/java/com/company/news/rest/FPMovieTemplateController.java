...
import com.company.news.service.FPMovieTemplateService;
...
public class FPMovieTemplateController extends AbstractRESTController {

	@Autowired
	private FPMovieTemplateService fPMovieTemplateService;
...
//			if(DBUtil.isSqlInjection(family_uuid, responseMessage))return "";
			...
			PageQueryResult pageQueryResult= fPMovieTemplateService.query(pData,model);
