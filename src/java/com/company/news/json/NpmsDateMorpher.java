 ...
 * 用于json时间格式转换，比DateMorpher增加了时间为空时的处理，避免抛异常
 */
public class NpmsDateMorpher extends AbstractObjectMorpher {
	 ...
	 */
	public NpmsDateMorpher(String[] formats) {
	 ...
	 */
	public NpmsDateMorpher(String[] formats, boolean lenient) {
	 ...
	 */
	public NpmsDateMorpher(String[] formats, Date defaultValue) {
	 ...
	 *            if the parsing should be lenient or not.
	 */
	public NpmsDateMorpher(String[] formats, Date defaultValue, Locale locale, boolean lenient) {
		super(true);
	 ...
	 *            the Locale used to parse each format.
	 */
	public NpmsDateMorpher(String[] formats, Locale locale) {
	 ...
	 *            if the parsing should be lenient or not.
	 */
	public NpmsDateMorpher(String[] formats, Locale locale, boolean lenient) {
		if (formats == null || formats.length == 0) {
			throw new MorphException("invalid array of formats");
		}
		// should use defensive copying ?
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof NpmsDateMorpher)) {
			return false;
		}

		NpmsDateMorpher other = (NpmsDateMorpher) obj;
